...
$(window).scroll(function() {
	...
	var footerPosition = $('.oa_footer').position().top + $('.oa_footer').outerHeight(true);
...
// ------------ Scrolled to Bottom ------------ //
$(window).scroll(function() {
	if ($(window).scrollTop() + $(window).height() == $(document).height() || $('.oa_footer').hasClass('oa_footer_fixed')) {
		$('.oa_logo').css({
			"color": "#191919",
